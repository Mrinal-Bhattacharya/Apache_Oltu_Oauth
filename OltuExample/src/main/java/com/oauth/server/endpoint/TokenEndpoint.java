...
public class TokenEndpoint {
    ...
    public Response authorize(@Context HttpServletRequest request) throws OAuthSystemException {
        ...
        try {
            ...
            if (!CLIENT_ID.equals(oauthRequest.getClientId())) {
            ...
            if (!CLIENT_SECRET.equals(oauthRequest.getClientSecret())) {
                OAuthResponse response =
            ...
            if (oauthRequest.getParam(OAuth.OAUTH_GRANT_TYPE)
                ...
                if (!AUTHORIZATION_CODE.equals(oauthRequest.getParam(OAuth.OAUTH_CODE))) {
                ...
                if (!PASSWORD.equals(oauthRequest.getPassword())
                    || !USERNAME.equals(oauthRequest.getUsername())) {
                    OAuthResponse response = OAuthASResponse
                        .errorResponse(HttpServletResponse.SC_BAD_REQUEST)
                        .setError(OAuthError.TokenResponse.INVALID_GRANT)
